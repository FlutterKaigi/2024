...
class _StringsHomePageTicketsNormalJa {
	...
	String get invitation => '一般チケットのクーポンコードをお持ちの方はこちら';
...
class _StringsHomePageTicketsNormalEn extends _StringsHomePageTicketsNormalJa {
	...
	@override String get invitation => 'For those who have a coupon code for a general ticket';
	@override String get couponCode => 'Coupon Code';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'homePage.tickets.normal.invitation': return '一般チケットのクーポンコードをお持ちの方はこちら';
			case 'homePage.tickets.normal.couponCode': return 'クーポンコード';
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'homePage.tickets.normal.invitation': return 'For those who have a coupon code for a general ticket';
			case 'homePage.tickets.normal.couponCode': return 'Coupon Code';
