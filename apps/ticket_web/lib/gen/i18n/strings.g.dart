...
class _StringsHomePageTicketsStudentJa {
	...
	String get description => 'FlutterKaigi 2024当日に、学生(高校・大学(短期大学,大学院を含む)・高等専門学校・専修学校・専門学校・職業訓練学校)の方は受付にて学生証を提示することによりチケット代金全額を返金致します。\n※返金は当日のみ有効です。また、一般チケットのみ対象となります。所属している教育機関が対象かどうか不明な場合は、運営にお問い合わせください。';
}
...
class _StringsTicketPageProfileEditRestrictionEn extends _StringsTicketPageProfileEditRestrictionJa {
	...
	@override String get description => '- Profile images can only be used with your Google account image or uploaded image.\n- You can edit your profile until **Nov 7 (Mon) 10:00 JST**. After that, you will **not be able to edit your profile** due to printing reasons.';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'homePage.tickets.student.description': return 'FlutterKaigi 2024当日に、学生(高校・大学(短期大学,大学院を含む)・高等専門学校・専修学校・専門学校・職業訓練学校)の方は受付にて学生証を提示することによりチケット代金全額を返金致します。\n※返金は当日のみ有効です。また、一般チケットのみ対象となります。所属している教育機関が対象かどうか不明な場合は、運営にお問い合わせください。';
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'homePage.tickets.student.description': return 'If you are a student (High school, University(Including Junior College, Graduate School), Technical College, College of Technology(KOSEN), Specialized School, Vocational School)on the day of FlutterKaigi 2024, we will refund the full ticket price by showing your student ID at time of reception.\n※ Refunds are only valid on the day of the event. Only general tickets are eligible. If you are unsure whether your educational institution is eligible, please contact the organizers.';
