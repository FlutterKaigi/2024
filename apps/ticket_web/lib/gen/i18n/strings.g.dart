...
class _StringsHomePageJa {
	...
	late final _StringsHomePageTicketWillBeOnSaleCardJa ticketWillBeOnSaleCard = _StringsHomePageTicketWillBeOnSaleCardJa._(_root);
	late final _StringsHomePagePrePurchaseWarningDialogJa prePurchaseWarningDialog = _StringsHomePagePrePurchaseWarningDialogJa._(_root);
...
class _StringsTicketPageJa {
	...
	late final _StringsTicketPageQrCodeJa qrCode = _StringsTicketPageQrCodeJa._(_root);
	late final _StringsTicketPageEntranceInformationJa entranceInformation = _StringsTicketPageEntranceInformationJa._(_root);
}
...
class _StringsHomePageTicketWillBeOnSaleCardJa {
	...
	String get description => 'チケットの販売は、2024年10月7日(月) 10:00 JST から開始されます。\nそれまでしばらくお待ちください。\n\n最新情報はFlutterKaigi公式Xアカウントでもお知らせします(@FlutterKaigi)';
...
class _StringsTicketPageEditFieldsJa {
	...
	late final _StringsTicketPageEditFieldsIsAdultJa isAdult = _StringsTicketPageEditFieldsIsAdultJa._(_root);
...
class _StringsHomePageTicketsStudentJa {
	...
	String get description => 'FlutterKaigi 2024当日に、学生(中学・高校・大学(短期大学,大学院を含む)・高等専門学校・専修学校・専門学校・職業訓練学校)の方は受付にて学生証を提示することによりチケット代金全額を返金致します。\n※返金は当日のみ有効です。また、一般チケットのみ対象となります。所属している教育機関が対象かどうか不明な場合は、運営にお問い合わせください。';
}
...
class _StringsTicketPageEditFieldsAvatarJa {
	...
	late final _StringsTicketPageEditFieldsAvatarCropJa crop = _StringsTicketPageEditFieldsAvatarCropJa._(_root);
}
...
class _StringsHomePageEn extends _StringsHomePageJa {
	...
	@override late final _StringsHomePageTicketWillBeOnSaleCardEn ticketWillBeOnSaleCard = _StringsHomePageTicketWillBeOnSaleCardEn._(_root);
	@override late final _StringsHomePagePrePurchaseWarningDialogEn prePurchaseWarningDialog = _StringsHomePagePrePurchaseWarningDialogEn._(_root);
...
class _StringsTicketPageEn extends _StringsTicketPageJa {
	...
	@override late final _StringsTicketPageQrCodeEn qrCode = _StringsTicketPageQrCodeEn._(_root);
	@override late final _StringsTicketPageEntranceInformationEn entranceInformation = _StringsTicketPageEntranceInformationEn._(_root);
}
...
// Path: homePage.ticketWillBeOnSaleCard
class _StringsHomePageTicketWillBeOnSaleCardEn extends _StringsHomePageTicketWillBeOnSaleCardJa {
	_StringsHomePageTicketWillBeOnSaleCardEn._(_StringsEn root) : this._root = root, super._(root);
...
// Path: homePage.prePurchaseWarningDialog
class _StringsHomePagePrePurchaseWarningDialogEn extends _StringsHomePagePrePurchaseWarningDialogJa {
	_StringsHomePagePrePurchaseWarningDialogEn._(_StringsEn root) : this._root = root, super._(root);

	@override final _StringsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Note on Pre-Purchase';
	@override String get accept => 'Accept';
	@override String get unaccept => 'Unaccept';
}
...
class _StringsTicketPageThankYouCardEn extends _StringsTicketPageThankYouCardJa {
	...
	@override String description({required Object type}) => 'You have a ${type}.';
}
...
class _StringsTicketPageEditFieldsEn extends _StringsTicketPageEditFieldsJa {
	...
	@override late final _StringsTicketPageEditFieldsIsAdultEn isAdult = _StringsTicketPageEditFieldsIsAdultEn._(_root);
...
class _StringsTicketPageQrCodeEn extends _StringsTicketPageQrCodeJa {
	_StringsTicketPageQrCodeEn._(_StringsEn root) : this._root = root, super._(root);
...
// Path: ticketPage.entranceInformation
class _StringsTicketPageEntranceInformationEn extends _StringsTicketPageEntranceInformationJa {
	_StringsTicketPageEntranceInformationEn._(_StringsEn root) : this._root = root, super._(root);

	@override final _StringsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Entrance Information';
...
class _StringsTicketPageEditFieldsAvatarEn extends _StringsTicketPageEditFieldsAvatarJa {
	...
	@override String get description => 'Please upload your profile image. (PNG, JPG format)';
	...
	@override late final _StringsTicketPageEditFieldsAvatarCropEn crop = _StringsTicketPageEditFieldsAvatarCropEn._(_root);
}

// Path: ticketPage.editFields.isAdult
class _StringsTicketPageEditFieldsIsAdultEn extends _StringsTicketPageEditFieldsIsAdultJa {
	_StringsTicketPageEditFieldsIsAdultEn._(_StringsEn root) : this._root = root, super._(root);

	@override final _StringsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Are you 20 or older on November 21, 2024?';
	@override String get description => 'Alcohol will be served at the party for 20 or older attendees.';
...
// Path: ticketPage.editFields.avatar.crop
class _StringsTicketPageEditFieldsAvatarCropEn extends _StringsTicketPageEditFieldsAvatarCropJa {
	_StringsTicketPageEditFieldsAvatarCropEn._(_StringsEn root) : this._root = root, super._(root);

	@override final _StringsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Please crop the image';
	@override String get cropButton => 'Crop';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'homePage.ticketWillBeOnSaleCard.title': return 'チケットはまだ販売されていません';
			case 'homePage.ticketWillBeOnSaleCard.description': return 'チケットの販売は、2024年10月7日(月) 10:00 JST から開始されます。\nそれまでしばらくお待ちください。\n\n最新情報はFlutterKaigi公式Xアカウントでもお知らせします(@FlutterKaigi)';
			case 'homePage.ticketWillBeOnSaleCard.button': return '公式Xアカウントへ';
			case 'homePage.prePurchaseWarningDialog.title': return 'チケット購入前の注意事項';
			case 'homePage.prePurchaseWarningDialog.accept': return '同意する';
			case 'homePage.prePurchaseWarningDialog.unaccept': return '同意しない';
			...
			case 'homePage.tickets.normal.description.0': return '**[一般チケットの特典]**';
			case 'homePage.tickets.normal.description.1': return '- **本編への参加**';
			case 'homePage.tickets.normal.description.2': return '- **懇親会への参加**';
			case 'homePage.tickets.normal.description.3': return '- **各種ノベルティ**';
			...
			case 'homePage.tickets.personalSponsor.description.0': return '- 個人スポンサー付き参加チケットは、一般チケットを内包します';
			case 'homePage.tickets.personalSponsor.description.1': return '';
			case 'homePage.tickets.personalSponsor.description.2': return '**[個人スポンサーの特典]**';
			case 'homePage.tickets.personalSponsor.description.3': return '- **前夜祭への参加**: 2024/11/20(水)に開催する前夜祭へ参加頂けます([詳細はこちら](https://medium.com/flutterkaigi/flutterkaigi-2024%E5%89%8D%E5%A4%9C%E7%A5%AD%E3%82%92%E9%96%8B%E5%82%AC%E3%81%97%E3%81%BE%E3%81%99-5e7ff7ba3947))';
			case 'homePage.tickets.personalSponsor.description.4': return '- **優先Viewing Area**: セッションルーム前方に優先エリアを設置';
			case 'homePage.tickets.personalSponsor.description.5': return '- **専用FlutterKaigiグッズ**';
			case 'homePage.tickets.personalSponsor.description.6': return '- **開会式でのメッセージ紹介**';
			case 'homePage.tickets.personalSponsor.description.7': return '- **Webサイトへのアイコン掲載**';
			case 'homePage.tickets.student.name': return '学割について';
			case 'homePage.tickets.student.description': return 'FlutterKaigi 2024当日に、学生(中学・高校・大学(短期大学,大学院を含む)・高等専門学校・専修学校・専門学校・職業訓練学校)の方は受付にて学生証を提示することによりチケット代金全額を返金致します。\n※返金は当日のみ有効です。また、一般チケットのみ対象となります。所属している教育機関が対象かどうか不明な場合は、運営にお問い合わせください。';
			...
			case 'ticketPage.thankYouCard.description': return ({required Object type}) => '${type} をお持ちです';
			...
			case 'ticketPage.editFields.avatar.crop.title': return '画像を切り取ってください';
			case 'ticketPage.editFields.avatar.crop.cropButton': return '切り取る';
			case 'ticketPage.editFields.isAdult.title': return 'FlutterKaigi 2024当日に成人していますか?';
			case 'ticketPage.editFields.isAdult.description': return '懇親会におけるアルコールの提供は、成人の方に限ります。';
			case 'ticketPage.editFields.isAdult.yes': return 'はい';
			case 'ticketPage.editFields.isAdult.no': return 'いいえ';
			case 'ticketPage.editFields.isAdult.ok': return 'OK';
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'homePage.prePurchaseWarningDialog.title': return 'Note on Pre-Purchase';
			case 'homePage.prePurchaseWarningDialog.accept': return 'Accept';
			case 'homePage.prePurchaseWarningDialog.unaccept': return 'Unaccept';
			...
			case 'homePage.tickets.normal.description.0': return '**[Normal Ticket Benefits]**';
			case 'homePage.tickets.normal.description.1': return '- **Access to the main event**';
			case 'homePage.tickets.normal.description.2': return '- **Access to the party**';
			case 'homePage.tickets.normal.description.3': return '- **Various Merchandise**';
			...
			case 'homePage.tickets.personalSponsor.description.0': return '- Personal Sponsor Ticket includes a general ticket';
			case 'homePage.tickets.personalSponsor.description.1': return '';
			case 'homePage.tickets.personalSponsor.description.2': return '**[Personal Sponsor Benefits]**';
			case 'homePage.tickets.personalSponsor.description.3': return '- **Pre-Party Access**: Access to the pre-party on November 20 (Wednesday) ([details here](https://medium.com/flutterkaigi/flutterkaigi-2024%E5%89%8D%E5%A4%9C%E7%A5%AD%E3%82%92%E9%96%8B%E5%82%AC%E3%81%97%E3%81%BE%E3%81%99-5e7ff7ba3947))';
			case 'homePage.tickets.personalSponsor.description.4': return '- **Exclusive Viewing Area**: Dedicated area in front of the session room';
			case 'homePage.tickets.personalSponsor.description.5': return '- **Exclusive FlutterKaigi Merchandise**';
			case 'homePage.tickets.personalSponsor.description.6': return '- **Introduction at the Opening Ceremony**';
			case 'homePage.tickets.personalSponsor.description.7': return '- **Icon on the Website**';
			case 'homePage.tickets.student.name': return 'Student Discount';
			case 'homePage.tickets.student.description': return 'If you are a student (Junior High School, High School, University(Including Junior College, Graduate School), Technical College, College of Technology(KOSEN), Specialized School, Vocational School)on the day of FlutterKaigi 2024, we will refund the full ticket price by showing your student ID at time of reception.\n※ Refunds are only valid on the day of the event. Only general tickets are eligible. If you are unsure whether your educational institution is eligible, please contact the organizers.';
			...
			case 'ticketPage.thankYouCard.description': return ({required Object type}) => 'You have a ${type}.';
			...
			case 'ticketPage.editFields.avatar.description': return 'Please upload your profile image. (PNG, JPG format)';
			...
			case 'ticketPage.editFields.avatar.crop.title': return 'Please crop the image';
			case 'ticketPage.editFields.avatar.crop.cropButton': return 'Crop';
			case 'ticketPage.editFields.isAdult.title': return 'Are you 20 or older on November 21, 2024?';
			case 'ticketPage.editFields.isAdult.description': return 'Alcohol will be served at the party for 20 or older attendees.';
			case 'ticketPage.editFields.isAdult.yes': return 'Yes';
			case 'ticketPage.editFields.isAdult.no': return 'No';
			case 'ticketPage.editFields.isAdult.ok': return 'OK';
