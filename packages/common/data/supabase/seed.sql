...
VALUES
  (
    ...
    '## スポンサー名 株式会社出前館  ## 概要 本セッションでは、出前館アプリにおけるFlutterアプリ設計、そしてそれらを支えるCICD環境について述べます。  セッション前半では出前館アプリのアプリ設計についてお話しします。 出前館アプリのフォルダ構成やAsset Management、そしてState Managementについてお話しします。 現在出前館では、提供するすべてのアプリでFlutterを採用しています。それら経験をご紹介しつつ、現在の出前館アプリのアプリ設計についてご紹介いたします。  セッション後半では出前館アプリを支えるCICD環境について述べます。 アプリ開発においてCICD環境はなくてはならない存在です。出前館アプリでは、これまでCICD環境(bitrise)の導入、React NativeからFlutterへの移行に伴う改修、そして新たなCICD環境(TeamCity)への移行に取り組んできました。 4年間という短い期間にこれだけの取り組みをしてきたチームは少ないでしょう。セッション後半では、この苦労と葛藤についてご紹介します。  ## 想定視聴者 ・Flutterを用いてアプリ開発を行うエンジニア ・CICD環境の構築やその運用に取り組むエンジニア',
    '2024-11-22 11:00:00+09',
    '2024-11-22 11:40:00+09',
    'f6ee9501-0698-44ea-ad21-eb051ee94a8e',
    18,
