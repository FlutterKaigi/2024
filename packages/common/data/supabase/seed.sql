...
INSERT INTO
  public.session_speakers_v2
VALUES
  ('71216c8c-fbb0-45e1-a72d-e544b6b712bd', 'a87ad2ac-dc69-44fb-861d-ef57f3a3f41b');

INSERT INTO
  public.session_speakers_v2
VALUES
  ('f6931b4e-30db-4a4e-9582-7a54c135b740', '0116ff6a-5171-44d3-9733-f047f2f17930');

INSERT INTO
  public.session_speakers_v2
VALUES
  ('b57f3efd-b31d-4d57-aaa3-f45f1b17f727', 'cefa50ab-4d04-4cf1-a3f9-9ee50e2b630b');

INSERT INTO
  public.session_speakers_v2
VALUES
  ('3bbe9e9a-d41f-4c4d-994c-0064cd30fd94', 'e34f0e48-bc98-4621-9fd8-97fab8e4f112');

INSERT INTO
  public.session_speakers_v2
VALUES
  ('369e19d9-1f27-40e6-b294-64c6ca9bfcae', 'e63e4871-1e52-41f5-845c-335a0ec77e66');
...
VALUES
  (
    1,
    '掲載期間（1900/1/1〜1999/12/31）が終了したお知らせ',
    'https://example.com',
    '1999-01-01 09:00:00.000000+09',
    '1999-12-31 23:59:59.999999+09'
  ),
  (
    2,
    'FlutterKaigi 2024 公式プロジェクトについて',
    'https://medium.com/flutterkaigi/2a94530837c7',
    '2024-10-25 09:00:00.000000+09',
    '2099-12-31 23:59:59.999999+09'
  ),
  (
    3, 
    'FlutterKaigi 2024 公式アプリについて',
    'https://medium.com/flutterkaigi/033a58493489',
    '2024-11-07 09:00:00.000000+09',
    NULL
  ),
  (
    4,
    '掲載期間（2100/1/1〜2100/12/31）が開始前のお知らせ',
    'https://example.com',
    '2100-01-01 09:00:00.000000+09',
    '2199-12-31 23:59:59.999999+09'
  );
